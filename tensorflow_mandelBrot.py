...
def Calculate_Colors(a, primary="red"):
    ...
    if primary == "red":
        ...
        img = np.concatenate([30+50*np.sin(a_cyclic),
...
def Create_Iteration_Matrix(min_x=-2.5, max_x=1, min_y=-1.3, max_y=1.3):
    ...
    # escape_value = tf.Variable(tf.zeros_like())
...
def main():
    ...
    while True:
        ...
        a = Calculate_Colors(ns, primary="red")
